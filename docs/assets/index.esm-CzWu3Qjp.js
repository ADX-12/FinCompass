import{r as A,_ as v,C as S,a as k,E as Y,o as Ce,F as J,g as b,b as Ee,d as ke,i as X,c as Q,e as Z,v as ee,L as Re,f as U}from"./index-DS5NXh9v.js";import"./charts-DLZR-pr3.js";const te="@firebase/installations",N="0.6.24";/**
 * @license
 ...
 */const ne=1e4,ae=`w:${N}`,ie="FIS_v2",Pe="https://firebaseinstallations.googleapis.com/v1",_e=60*60*1e3,De="installations",Fe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tn(e=Ee()){e=b(e);const t=k(e,E);return t.isInitialized()?t.getImmediate():Wt(e)}function Wt(e,t={}){const n=k(e,E);if(n.isInitialized()){const i=n.getImmediate();if(ke(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function nn(){if(X()||!Q()||!Z())return!1;try{return await ee()}catch{return!1}}function an(e,t,n){e=b(e),xt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}async function rn(e){return e=b(e),Ut(g,p[e.app.options.appId])}function sn(e,t,n){e=b(e),qt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function Yt(e,t,n){e=b(e),jt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function on(e,t){e=b(e),Bt(p[e.app.options.appId],t).catch(n=>u.error(n))}function cn(e){g?g("set",e):ve(e)}function Jt(e,t,n,a){e=b(e),Lt(g,p[e.app.options.appId],t,n,a).catch(i=>u.error(i))}function ln(e){g?g("consent","update",e):Ae(e)}const K="@firebase/analytics",W="0.10.25";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
